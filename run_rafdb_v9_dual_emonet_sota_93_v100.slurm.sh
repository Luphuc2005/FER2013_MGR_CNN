#!/bin/bash
#SBATCH --job-name=RAFDB_V9_DUAL_EMONET
...
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_V9_DUAL_EMONET_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_V9_DUAL_EMONET_%j.err
set -euo pipefail

ROOT=/home/ptbao/projects/FER2013_MGR_CNN
cd "$ROOT"
FER_PY="$ROOT/fer2013_env/bin/python"
CONFIG="$ROOT/config_rafdb_v9_dual_emonet_sota_93.yaml"
OUTPUT_DIR="$ROOT/outputs/papers/rafdb_v9_dual_emonet_sota_93"
...
echo 'V9 Dual-EmoNet SOTA 93%: Mild Fear Oversampling (253 -> 500) + Direct 1024-dim Fusion + Adaptive Semantic Gate'
...
if [[ "${SMOKE_ONLY:-0}" == "1" ]]; then
    echo 'V9_DUAL_EMONET_SMOKE_ONLY_COMPLETE; training not started.'
    exit 0
fi
...
echo "V9_DUAL_EMONET_TRAIN_COMPLETE: $OUTPUT_DIR"
