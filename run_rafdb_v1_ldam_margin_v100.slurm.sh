#!/bin/bash
#SBATCH --job-name=V1_LDAM_MARGIN
...
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/V1_LDAM_MARGIN_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/V1_LDAM_MARGIN_%j.err
...
CONFIG="$ROOT/config_rafdb_v1_ldam_margin.yaml"
OUTPUT_DIR="$ROOT/outputs/papers/rafdb_v1_ldam_margin"
...
echo "=========================================================================="
echo " RAF-DB V1 LDAM Margin (Single Model, Standard Split)"
echo " Core: Long-Tail Logit Adjustment Margin (tau=0.35) for Fear & Disgust"
echo " Config     : $CONFIG"
...
# Run Full Training
echo ""
echo ">>> Starting RAF-DB V1 LDAM Margin Training (60 epochs max, early-stopping patience=20)..."
...
echo ""
echo "=========================================================================="
echo " [SUCCESS] RAF-DB V1 LDAM Margin Training & Evaluation Completed!"
