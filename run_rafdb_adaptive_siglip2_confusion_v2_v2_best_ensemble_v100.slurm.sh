#!/bin/bash
#SBATCH --job-name=RAFDB_V2V2_ENS
...
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_V2V2_ENS_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_V2V2_ENS_%j.err
...
CHECKPOINT_DIR="$ROOT/outputs/papers/rafdb_adaptive_siglip2_confusion_v2_v2/checkpoints/best"
REPORT="$ROOT/outputs/papers/rafdb_adaptive_siglip2_confusion_v2_v2/best_top5_tta_ensemble_report.json"
CHECKPOINTS=(ckpt-12 ckpt-19 ckpt-36 ckpt-52 ckpt-60)
...
echo "============================================================"
echo " RAF-DB Adaptive SigLIP2 v2_v2: Best Top-5 TTA Ensemble"
echo "============================================================"
...
echo "============================================================"
echo " RAF-DB V2_V2 BEST TOP-5 ENSEMBLE COMPLETED"
echo " Report: $REPORT"
echo " End: $(date)"
echo "============================================================"
