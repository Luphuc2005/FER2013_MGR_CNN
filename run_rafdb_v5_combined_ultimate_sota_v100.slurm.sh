...
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_V5_SOTA_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_V5_SOTA_%j.err
set -euo pipefail
...
echo "Finished: $OUTPUT_DIR (v5 Combined Ultimate SOTA Tuned)."
