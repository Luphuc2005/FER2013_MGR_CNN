#!/bin/bash
#SBATCH --job-name=RAFDB_BASELINE
...
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_BASELINE_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_BASELINE_%j.err
...
mkdir -p logs outputs/papers/rafdb_convnext_base_ms1m_baseline

export PYTHONUNBUFFERED=1
export PYTHONPATH="$ROOT:${PYTHONPATH:-}"

FER_PY="/home/ptbao/projects/FER2013_MGR_CNN/fer2013_env/bin/python"
CONFIG="$ROOT/config_rafdb_convnext_base_ms1m_baseline.yaml"

echo "============================================================"
echo " RAF-DB ConvNeXt-Base MS1M Baseline (7 Classes)"
echo "============================================================"
...
echo "Output: outputs/papers/rafdb_convnext_base_ms1m_baseline"
echo "============================================================"
...
# 1. Train Model
echo "============================================================"
echo " Starting Full RAF-DB Baseline Training..."
echo "============================================================"
...
echo "============================================================"
echo " RAF-DB Baseline Completed Successfully!"
echo " End: $(date)"
echo "============================================================"
