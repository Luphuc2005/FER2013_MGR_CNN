#!/bin/bash
#SBATCH --job-name=EVAL_V5_MOD_ENS
...
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/EVAL_V5_MOD_ENS_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/EVAL_V5_MOD_ENS_%j.err
set -euo pipefail
...
echo "=========================================================================="
echo " Running Ensemble Evaluation for v5 Ultimate Moderate Aug (Best Acc + Best Loss)"
echo " Config:         $CONFIG"
