#!/bin/bash
#SBATCH --job-name=EVAL_V5_ULTIMATE_CPU
#SBATCH --cpus-per-task=32
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/EVAL_V5_ULTIMATE_CPU_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/EVAL_V5_ULTIMATE_CPU_%j.err
...
# Ép chặt chạy CPU thuần túy, tuyệt đối không cấp phát VRAM GPU
...
echo "=========================================================================="
echo " Running Ensemble + Multi-View TTA + TTA Sweep on CPU"
...
echo "=========================================================================="
echo " CPU Evaluation completed successfully at $(date)"
echo " Report: $OUTPUT_DIR/eval_ensemble_best_acc_and_loss_cpu_report.json"
echo " Log:    logs/EVAL_V5_ULTIMATE_CPU_${SLURM_JOB_ID:-standalone}.out"
echo "=========================================================================="
