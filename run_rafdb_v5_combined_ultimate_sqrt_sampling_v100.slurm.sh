...
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_V5_SQRT_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_V5_SQRT_%j.err
set -euo pipefail
...
OUTPUT_DIR="$ROOT/outputs/papers/rafdb_siglip2_semantic_stable_v5_combined_ultimate_sqrt_sampling"
...
echo "Finished: $OUTPUT_DIR (v5 Combined Ultimate + Square-Root Sampling)."