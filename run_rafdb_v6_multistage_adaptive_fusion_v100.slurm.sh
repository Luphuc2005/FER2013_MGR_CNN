#!/bin/bash
#SBATCH --job-name=RAFDB_V6_MS_B32
...
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_V6_MS_B32_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_V6_MS_B32_%j.err
set -euo pipefail
