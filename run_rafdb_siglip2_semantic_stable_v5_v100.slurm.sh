...
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_SEM_STABLE_V5_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_SEM_STABLE_V5_%j.err

set -euo pipefail

ROOT=/home/ptbao/projects/FER2013_MGR_CNN
FER_PY="$ROOT/fer2013_env/bin/python"
CONFIG="$ROOT/config_rafdb_siglip2_semantic_stable_v5.yaml"
OUTPUT_DIR="$ROOT/outputs/papers/rafdb_siglip2_semantic_stable_v5"
...
echo "============================================================"
echo " RAF-DB SigLIP2 Semantic-Stable v5"
echo " Inference Logit Soft Fusion: alpha=0.15 (ConvNeXt + SigLIP2)"
...
echo "============================================================"
echo " Validating semantic-stable v5 config contract..."
echo "============================================================"
"$FER_PY" -u scripts/check_semantic_stable_v5_contract.py "$CONFIG"
...
echo "============================================================"
echo " Starting RAF-DB Semantic-Stable v5 training..."
echo "============================================================"
...
echo "============================================================"
echo " RAF-DB Semantic-Stable v5 pipeline completed successfully"
echo " End: $(date)"
echo "============================================================"
