#!/bin/bash
#SBATCH --job-name=FER_SIGLIP2_SEED42
...
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/FER_SIGLIP2_SEED42_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/FER_SIGLIP2_SEED42_%j.err
...
mkdir -p logs outputs/papers/siglip2-confusion-seed42
...
echo "============================================================"
echo " FER2013 ConvNeXt-Base MS1M SigLIP 2 Confusion (Seed 42)"
...
echo "FER_PY=$FER_PY"
echo "CONFIG=$CONFIG"
echo "Output: outputs/papers/siglip2-confusion-seed42"
echo "============================================================"
...
echo "============================================================"
BEST_LOSS_CKPT=$(ls -d $ROOT/outputs/papers/siglip2-confusion-seed42*/checkpoints/best_loss/ckpt-*.index 2>/dev/null | tail -n 1 | sed 's/\.index$//' || true)
...
echo "============================================================"
echo " Completed Seed 42 Pipeline (Training + TTA + Top-5 Ensemble)"
echo " End: $(date)"
echo "============================================================"
