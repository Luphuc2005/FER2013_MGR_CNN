...
export TF_NUM_INTRAOP_THREADS="${TF_NUM_INTRAOP_THREADS:-24}"
export TF_NUM_INTEROP_THREADS="${TF_NUM_INTEROP_THREADS:-8}"
export MGR_TF_INTRA_OP_THREADS="${MGR_TF_INTRA_OP_THREADS:-24}"
export MGR_TF_INTER_OP_THREADS="${MGR_TF_INTER_OP_THREADS:-8}"
...
export MGR_PREFETCH_BUFFER="${MGR_PREFETCH_BUFFER:-4}"
export MGR_SHUFFLE_BUFFER="${MGR_SHUFFLE_BUFFER:-1024}"
export MGR_USE_NUMACTL="${MGR_USE_NUMACTL:-0}"
unset MGR_MAX_TRAIN_SAMPLES
unset MGR_MAX_VAL_SAMPLES
unset MGR_MAX_TEST_SAMPLES

PRIMARY_BATCH="${MGR_PRIMARY_BATCH_SIZE_PER_GPU:-16}"
