#!/bin/bash
#SBATCH --job-name=RAFDB_V6_MS_B16
...
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_V6_MS_B16_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_V6_MS_B16_%j.err
set -euo pipefail
ROOT=/home/ptbao/projects/FER2013_MGR_CNN
cd "$ROOT"
FER_PY="$ROOT/fer2013_env/bin/python"
CONFIG="$ROOT/config_rafdb_siglip2_semantic_stable_v6_multistage_adaptive_fusion_batch16.yaml"
OUTPUT_DIR="$ROOT/outputs/papers/rafdb_siglip2_semantic_stable_v6_multistage_adaptive_fusion_batch16"
...
"$FER_PY" -u scripts/check_rafdb_v6_multistage_batch16.py --config "$CONFIG" --smoke --model-smoke
