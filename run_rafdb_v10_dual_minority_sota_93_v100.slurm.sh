#!/bin/bash
#SBATCH --job-name=RAFDB_V10_DUAL_MINORITY
...
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_V10_DUAL_MINORITY_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_V10_DUAL_MINORITY_%j.err
set -euo pipefail

ROOT=/home/ptbao/projects/FER2013_MGR_CNN
cd "$ROOT"
FER_PY="$ROOT/fer2013_env/bin/python"
CONFIG="$ROOT/config_rafdb_v10_dual_minority_sota_93.yaml"
OUTPUT_DIR="$ROOT/outputs/papers/rafdb_v10_dual_minority_sota_93"
...
echo 'V10 Dual-Minority SOTA 93%: Fear (253 -> 500) + Disgust (645 -> 850) + 112x112 ArcFace Receptive Field'
echo 'SAM (rho=0.02) + AdamW (5e-6 backbone) + DropPath 0.35 + Gate Floor T_end=1.6 + Semantic Decay (0.08 -> 0.01).'
...
if [[ "${SMOKE_ONLY:-0}" == "1" ]]; then
    echo 'V10_DUAL_MINORITY_SMOKE_ONLY_COMPLETE; training not started.'
    exit 0
fi
...
echo "V10_DUAL_MINORITY_TRAIN_COMPLETE: $OUTPUT_DIR"
