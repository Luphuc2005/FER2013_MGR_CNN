#!/bin/bash
#SBATCH --job-name=RAFDB_V9_SOTA93
...
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_V9_SOTA93_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_V9_SOTA93_%j.err
set -euo pipefail

ROOT=/home/ptbao/projects/FER2013_MGR_CNN
cd "$ROOT"
FER_PY="$ROOT/fer2013_env/bin/python"
CONFIG="$ROOT/config_rafdb_v9_single_sota_93.yaml"
OUTPUT_DIR="$ROOT/outputs/papers/rafdb_v9_single_sota_93"
...
echo 'V9 Single SOTA 93%: Direct 1024-dim Global-Regional Fusion + Adaptive Semantic Fusion Gate alpha(x) <= 0.10'
...
if [[ "${SMOKE_ONLY:-0}" == "1" ]]; then
    echo 'V9_SMOKE_ONLY_COMPLETE; training not started.'
    exit 0
fi
...
echo "V9_TRAIN_COMPLETE: $OUTPUT_DIR"
