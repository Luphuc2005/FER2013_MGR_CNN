...
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_V5_LGSA_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_V5_LGSA_%j.err
set -euo pipefail
...
echo "Finished: $OUTPUT_DIR (V5 LGSA Explicit Local-Global Semantic Alignment)."
