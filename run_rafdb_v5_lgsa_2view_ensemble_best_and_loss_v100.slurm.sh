#!/bin/bash
#SBATCH --job-name=EVAL_V5_LGSA_2V
...
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/EVAL_V5_LGSA_2V_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/EVAL_V5_LGSA_2V_%j.err
set -euo pipefail
...
echo "=========================================================================="
echo " Running FAST 2-View TTA (Origin + Flip) Ensemble on GPU (32GB VRAM)"
echo " Config:         $CONFIG"
