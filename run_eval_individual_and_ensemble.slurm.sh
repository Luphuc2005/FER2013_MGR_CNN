#!/bin/bash
#SBATCH --job-name=EVAL_INDIVIDUAL_AND_ENSEMBLE
...
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/EVAL_INDIVIDUAL_ENSEMBLE_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/EVAL_INDIVIDUAL_ENSEMBLE_%j.err
...
# Tối ưu đa luồng CPU (32 threads)
...
# Tự động chọn file config phù hợp
...
echo "============================================================"
echo " EVALUATION: INDIVIDUAL CHECKPOINTS + TOP-5 ENSEMBLE"
echo "============================================================"
...
# 1. Chạy đánh giá chi tiết từng Checkpoint và tính Softmax Ensemble
echo -e "\n============================================================"
echo " Running Individual Checkpoint Evaluations + Ensemble (TEST SPLIT)"
echo "============================================================"
...
echo "============================================================"
echo " Evaluation Pipeline Completed Successfully at: $(date)"
echo "============================================================"
