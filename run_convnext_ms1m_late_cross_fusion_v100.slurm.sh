#!/bin/bash
#SBATCH --job-name=FER_LATE_CROSS_FUSION
...
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/FER_LATE_CROSS_FUSION_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/FER_LATE_CROSS_FUSION_%j.err
...
mkdir -p logs outputs/convnext_ms1m_late_cross_fusion/checkpoints
...
CONFIG="$ROOT/config_kaggle_convnext_ms1m_late_cross_fusion.yaml"
...
echo "============================================================"
echo " FER2013 ConvNeXt-B MS1M Late Cross-Stage Fusion (1x V100)"
echo "============================================================"
...
echo "FER_PY=$FER_PY"
echo "CONFIG=$CONFIG"
echo "Output: outputs/convnext_ms1m_late_cross_fusion"
echo "Start: $(date)"
echo "============================================================"
...
"$FER_PY" -u scripts/train_convnext_ms1m_late_cross_fusion.py \
  --config "$CONFIG"

echo "============================================================"
echo " FER2013 Late Cross-Stage Fusion training completed"
echo "End: $(date)"
echo "============================================================"
