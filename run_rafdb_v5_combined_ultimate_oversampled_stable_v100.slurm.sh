#!/bin/bash
#SBATCH --job-name=RAFDB_V5_OS_STABLE
...
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_V5_OS_STABLE_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_V5_OS_STABLE_%j.err
set -euo pipefail

ROOT=/home/ptbao/projects/FER2013_MGR_CNN
cd "$ROOT"
FER_PY="$ROOT/fer2013_env/bin/python"
CONFIG="$ROOT/config_rafdb_v5_combined_ultimate_oversampled_stable.yaml"
OUTPUT_DIR="$ROOT/outputs/papers/rafdb_v5_combined_ultimate_oversampled_stable"
...
echo "Running pre-flight verification suite..."
"$FER_PY" -u scripts/check_rafdb_v5_oversampled_stable.py --config "$CONFIG"
...
echo "Finished: $OUTPUT_DIR (RAF-DB V5 Combined Ultimate Oversampled Stable)."
