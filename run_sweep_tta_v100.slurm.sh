#!/bin/bash
#SBATCH --job-name=TTA_SWEEP_SIGLIP2
...
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/TTA_SWEEP_SIGLIP2_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/TTA_SWEEP_SIGLIP2_%j.err
...
echo "============================================================"
echo " TTA Weight Sweep Grid Search (V100 GPU)"
echo "============================================================"
...
echo "============================================================"
echo " TTA Weight Sweep Grid Search Completed"
echo " End: $(date)"
echo "============================================================"
