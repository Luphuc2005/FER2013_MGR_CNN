#!/bin/bash
#SBATCH --job-name=RAFDB_V8_3_OPT
...
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_V8_3_OPT_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_V8_3_OPT_%j.err
set -euo pipefail

ROOT=/home/ptbao/projects/FER2013_MGR_CNN
cd "$ROOT"
FER_PY="$ROOT/fer2013_env/bin/python"
CONFIG="$ROOT/config_rafdb_v8_3_optimal.yaml"
OUTPUT_DIR="$ROOT/outputs/papers/rafdb_v8_3_optimal"
...
echo "Finished: $OUTPUT_DIR (V8.3 Optimal: Direct Global-Regional Fusion + Adaptive Semantic Fusion Gate)."
