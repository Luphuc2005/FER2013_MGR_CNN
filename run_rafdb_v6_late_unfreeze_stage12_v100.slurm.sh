#!/bin/bash
#SBATCH --job-name=RAFDB_V6_LATE_UF
...
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_V6_LATE_UF_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_V6_LATE_UF_%j.err
set -euo pipefail

ROOT=/home/ptbao/projects/FER2013_MGR_CNN
cd "$ROOT"
FER_PY="$ROOT/fer2013_env/bin/python"
CONFIG="$ROOT/config_rafdb_v6_late_unfreeze_stage12.yaml"
OUTPUT_DIR="$ROOT/outputs/papers/rafdb_v6_late_unfreeze_stage12"
...
echo "Finished: $OUTPUT_DIR (V6 late unfreeze Stage 1&2 with micro-LR)."
