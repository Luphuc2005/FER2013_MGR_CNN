#!/bin/bash
#SBATCH --job-name=FER_MSDA_RESIDUAL
...
#SBATCH --mem=32G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/FER_MSDA_RESIDUAL_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/FER_MSDA_RESIDUAL_%j.err

set -euo pipefail

ROOT=/home/ptbao/projects/FER2013_MGR_CNN
FER_PY=/home/ptbao/projects/FER2013_MGR_CNN/fer2013_env/bin/python
CONFIG="$ROOT/config_convnext_ms1m_crossstage_msda_residual.yaml"
OUTPUT_DIR="$ROOT/outputs/tf_runs/convnext_ms1m_crossstage_msda_residual"
...
# Configure NVIDIA CUDA/CUDNN libraries for TensorFlow GPU in the project env.
...
echo "============================================================"
echo " FER2013 ConvNeXt-B MS1M Cross-Stage MSDA Residual (1x V100)"
echo "============================================================"
...
echo "============================================================"
echo " FER2013 MSDA Residual training completed"
echo "End: $(date)"
echo "============================================================"
