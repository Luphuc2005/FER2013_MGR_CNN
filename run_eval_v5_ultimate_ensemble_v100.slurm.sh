#!/bin/bash
#SBATCH --job-name=EVAL_V5_ULTIMATE
...
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/EVAL_V5_ULTIMATE_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/EVAL_V5_ULTIMATE_%j.err
set -euo pipefail
...
echo "=========================================================================="
echo " Running Ensemble + Multi-View TTA Evaluation for v5 Combined Ultimate"
echo " Config:         $CONFIG"
