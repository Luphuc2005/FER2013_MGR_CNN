#!/bin/bash
#SBATCH --job-name=RAFDB_V5_OVERSAMPLED
...
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_V5_OVERSAMPLED_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_V5_OVERSAMPLED_%j.err
set -euo pipefail

ROOT=/home/ptbao/projects/FER2013_MGR_CNN
cd "$ROOT"
FER_PY="$ROOT/fer2013_env/bin/python"
CONFIG="$ROOT/config_rafdb_v5_combined_ultimate_oversampled.yaml"
OUTPUT_DIR="$ROOT/outputs/papers/rafdb_v5_combined_ultimate_oversampled"
...
echo "Finished: $OUTPUT_DIR (V5 Combined Ultimate + Class-Aware Stochastic Minority Oversampling)."
