#!/bin/bash
#SBATCH --job-name=V1_NOISE_FILTER
...
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/V1_NOISE_FILTER_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/V1_NOISE_FILTER_%j.err
...
OUTPUT_DIR="$ROOT/outputs/papers/rafdb_v1_noise_filtering"
...
echo "=========================================================================="
echo " RAF-DB V1 Noise Filtering (Single Model, Standard Split)"
echo " Core: Sample-Confidence Downweighting for Ambiguous/Noisy Labels"
echo " Config     : $CONFIG"
...
# Run Full Training
echo ""
echo ">>> Starting RAF-DB V1 Noise Filtering Training (60 epochs max, early-stopping patience=20)..."
...
echo ""
echo "=========================================================================="
echo " [SUCCESS] RAF-DB V1 Noise Filtering Training & Evaluation Completed!"
