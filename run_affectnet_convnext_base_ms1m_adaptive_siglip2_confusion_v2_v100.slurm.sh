...
CONFIG="$ROOT/config_affectnet_convnext_base_ms1m_adaptive_siglip2_confusion_v2.yaml"

echo "============================================================"
echo " AffectNet-7 ConvNeXt-Base MS1M Adaptive SigLIP2 + Confusion v2"
echo "============================================================"
...
echo "FER_PY=$FER_PY"
echo "CONFIG=$CONFIG"
echo "Output: outputs/papers/affectnet_siglip2_confusion_v2"
echo "============================================================"
...
# 0. Smoke test first
echo "============================================================"
echo " Running AffectNet-7 Pipeline Smoke Test..."
echo "============================================================"
"$FER_PY" -u scripts/smoketest_affectnet_pipeline.py --config "$CONFIG" --num-batches 5 || exit 1

# 1. Train Model
echo "============================================================"
echo " Starting AffectNet-7 Full Training..."
echo "============================================================"
...
echo "============================================================"
BEST_LOSS_CKPT=$(ls -d $ROOT/outputs/papers/affectnet_siglip2_confusion_v2*/checkpoints/best_loss/ckpt-*.index 2>/dev/null | tail -n 1 | sed 's/\.index$//' || true)
...
echo "============================================================"
echo " AffectNet-7 SigLIP2 v2 Pipeline Completed"
echo " End: $(date)"
echo "============================================================"
