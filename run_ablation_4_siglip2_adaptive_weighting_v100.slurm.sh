#!/bin/bash
#SBATCH --job-name=ABLATION_4_ADAPT
...
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/ABLATION_4_ADAPT_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/ABLATION_4_ADAPT_%j.err
...
CONFIG="$ROOT/config_ablation_4_siglip2_adaptive_weighting.yaml"
