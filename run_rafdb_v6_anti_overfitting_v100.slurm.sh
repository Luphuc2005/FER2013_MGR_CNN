#!/bin/bash
#SBATCH --job-name=RAFDB_V6_ANTIOV
...
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_V6_ANTIOV_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_V6_ANTIOV_%j.err
set -euo pipefail
...
echo "Finished: $OUTPUT_DIR (V6 anti-overfitting progressive unfreezing)."
